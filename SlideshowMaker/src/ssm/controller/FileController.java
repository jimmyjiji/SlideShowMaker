...
import ssm.view.WebViewSlideShow;
/**
...
public class FileController {
     ...
     * data.
     */
    public FileController(SlideShowMakerView initUI, SlideShowFileManager initSlideShowIO, SlideShowModel model) {
        // NOTHING YET
        saved = true;
	ui = initUI;
        ...
        try {
            if (fileDirectory.exists()) {
                ...
                for (int i = 0; i < slides.size(); i++) {
                    BufferedImage image = ImageIO.read(new File(imagePath + slides.get(i).getImageFileName()));
