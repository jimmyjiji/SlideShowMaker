...
public class SlideShowMakerView {
	...
	slidesEditorScrollPane = new ScrollPane(slidesEditorPane);
        slidesEditorScrollPane.getStyleClass().add("slides_editor_scroll_pane");
	initTitleControls();
	...
	fileController = new FileController(this, fileManager, slideShow);
	...
	viewSlideShowButton.setOnAction(e -> {
	    fileController.handleViewSlideShowRequest(titleTextField.getText());
	});
	...
	fileToolbarPane = new HBox();
        fileToolbarPane.getStyleClass().add("file_Toolbar_Pane");
        // HERE ARE OUR FILE TOOLBAR BUTTONS, NOTE THAT SOME WILL
	// START AS ENABLED (false), WHILE OTHERS DISABLED (true)
	PropertiesManager props = PropertiesManager.getPropertiesManager();
 
	newSlideShowButton = initChildButton(fileToolbarPane, ICON_NEW_SLIDE_SHOW,	TOOLTIP_NEW_SLIDE_SHOW,	    "horizontal_toolbar_button", false);
	loadSlideShowButton = initChildButton(fileToolbarPane, ICON_LOAD_SLIDE_SHOW,	TOOLTIP_LOAD_SLIDE_SHOW,    "horizontal_toolbar_button", false);
	saveSlideShowButton = initChildButton(fileToolbarPane, ICON_SAVE_SLIDE_SHOW,	TOOLTIP_SAVE_SLIDE_SHOW,    "horizontal_toolbar_button", true);
	viewSlideShowButton = initChildButton(fileToolbarPane, ICON_VIEW_SLIDE_SHOW,	TOOLTIP_VIEW_SLIDE_SHOW,    "horizontal_toolbar_button", true);
	exitButton = initChildButton(fileToolbarPane, ICON_EXIT, TOOLTIP_EXIT, "horizontal_toolbar_button", false);
    }
	...
	// WE'LL USE TO STYLIZE OUR GUI CONTROLS, AND OPEN THE WINDOW
        String x = this.getClass().getResource(STYLE_SHEET_UI).toExternalForm();
   
	primaryScene.getStylesheets().add(x);
